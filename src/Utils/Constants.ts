 ...
 */
const MaxBulkDeletableMessageAge = 1_209_600_000;
 ...
 */
const GuildTextBasedChannelTypes = [
 ...
 */
const TextBasedChannelTypes = [...exports.GuildTextBasedChannelTypes, ChannelType.DM];
 ...
 */
const VoiceBasedChannelTypes = [ChannelType.GuildVoice, ChannelType.GuildStageVoice];
